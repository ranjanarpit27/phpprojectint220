...
<section class="contact_us section-padding">
  <div class="container">
    <div  class="row">
      ...
      <div class="col-md-6">
        <h3>Contact Info</h3>
        <h4>We are Available 24x7 @ 9512341234</h4>
        <div>
          <h5>DELHI-NCR</h5>
          <p>71/2 D, Rama Road, Najafgarh Road Industrial Area, Moti Nagar, New Delhi, Delhi 110015</p>
          <hr>
          <h5>MUMBAI</h5>
          <p>Plot No - 94, Marol Co-operative, Industrial Estate, Andheri-Kurla Road</p>
          <hr>
          <h5>BENGALURU</h5>
          <p>No. 1,Bandappa Colony New Bypanahalli Extention Opposite to Mont Fort College Old Madras Road Bengaluru-560038</p>
          <hr>
          <h5>KOLKATA</h5>
          <p>Plot 5, Block - GP,1st Floor,Sector - V, Salt Lake,Kolkata-700 091</p>
          <hr>
        </div>
